...
if 1==11:
	...
	.option("usePlainNumberFormat","true")\
        ...
        .option("header", "true")\
        .format("excel")\
        .load("/home/spark/file_home_worke/s4.xlsx").where(col("title") == "news")\
        .withColumn("dt", current_timestamp())\
        .write.format("jdbc").option("url","jdbc:mysql://localhost:33061/spark?user=root&password=1")\
        .option("driver", "com.mysql.cj.jdbc.Driver").option("dbtable", "tasketl4a")\
        .mode("append").save()
...
df1 = spark.read.format("com.crealytics.spark.excel")\
	...
	.option("usePlainNumberFormat","true")\
        ...
        .option("header", "true")\
        .format("excel")\
        .load("/home/spark/file_home_worke/s4_2.xlsx").limit(1000)\
...
ORDER BY 1
"""
df2 = spark.read.format("jdbc").option("url","jdbc:mysql://localhost:33061/spark?user=root&password=1")\
...
output_dir = '/home/spark/file_home_worke/'
# File name diagram
output_file = os.path.join(output_dir, 's6.png')
